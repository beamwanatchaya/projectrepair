...
const PopularCard = ({ isLoading }) => {
    ...
    useEffect(() => {
        if (JSON.parse(localStorage.getItem("userData")).role === "admin") {
            ...
            // })
            axios.get(`http://localhost:8080/api/repair/getuser`).then(res => {
                // console.log(res.data)
                // setdata(res.data)
                setdata(res.data)
    ...
    const adduser = (e) => {
        ...
        axios.post("http://localhost:8080/api/repair/genusername", data).then(res => {
            console.log(res)
            axios.get(`http://localhost:8080/api/repair/getuser`).then(res => {
                // console.log(res.data)
                // setdata(res.data)
    ...
    const deleted = (id) => {
        console.log("id:", id)
        axios.get(`http://localhost:8080/api/repair/deleteuser/${id}`).then(res => {
            console.log(res)
